...
- [fetchMap](https://deck.gl/docs/api-reference/carto/fetch-map) function, making it easy to load a Builder map to improve collaboration between map designers and developers.
