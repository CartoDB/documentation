...
```sql
WITH t AS (
  SELECT ST_GEOMFROMWKT("POLYGON ((10 10, 110 10, 110 110, 10 110, 10 10), (20 20, 20 30, 30 30, 30 20, 20 20), (40 20, 40 30, 50 30, 50 20, 40 20))") as geom
)
SELECT ST_ASTEXT(ST_INTERIORRINGN(geom, 1)) FROM t
