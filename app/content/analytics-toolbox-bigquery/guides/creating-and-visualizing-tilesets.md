...
The CARTO Workspace offers a user interface that you can use to create [tilesets](/analytics-toolbox-bigquery/overview/tilesets/#tileset-types-and-procedures). The option _Create tileset_ is available from the Data Explorer for those tables that are too big to be visualized directly and therefore require the creation of a tileset.
