...
<div style="text-align:center" >
<img src="/img/sf-spatial-extension/examples/sf-enrichment-example-3.png" alt="Store locations and 3km buffers." style="width:90%">
</div>
...
<div style="text-align:center" >
<img src="/img/sf-spatial-extension/examples/sf-enrichment-example-4.png" alt="Quadkey polyfills of store buffers." style="width:90%">
</div>
...
<div style="text-align:center" >
<img src="/img/sf-spatial-extension/examples/sf-enrichment-example-5.png" alt="Enriched polyfill buffers." style="width:90%">
</div>
...
<div style="text-align:center" >
<img src="/img/sf-spatial-extension/examples/sf-enrichment-example-result.png" alt="Store characterization by population covered by catchment area." style="width:100%">
</div>