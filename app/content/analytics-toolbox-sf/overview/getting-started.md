...
Keep reading to learn how to access CARTO's Analytics Toolbox via Snowflake's Data Marketplace.

{{% bannerNote title="STAY IN THE LOOP" type="tip" %}}
Join our [Google Group](https://groups.google.com/a/cartodb.com/g/snowflake-spatial-extension) to stay informed of any new feature launches and relevant changes to the Analytics Toolbox. Start a conversation with us in our [Discord channel](https://discord.gg/4U5XVrGyqW).
{{%/ bannerNote %}}


### Accessing the Analytics Toolbox
...
By cicking on "View Database" you will be redirected to the database you just created, where you will be able to browse all the modules (schemas) and functions and procedures available within the Analytics Toolbox. 
