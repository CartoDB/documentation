...
* `input_id_column`: `STRING` name of a column in the query that identifies each row uniquely.
...
{{% bannerNote type="code" %}}
data.DATAOBS_SUBSCRIPTIONS(subscriptions_project STRING, subscriptions_dataset STRING, filters STRING)
{{%/ bannerNote %}}
...
```sql
CALL carto-st.data.DATAOBS_SUBSCRIPTIONS('do-myorg-de4a1b21c14326c53184', 'do_us_myuser_3a21c14322b214326', '');
```

### DATAOBS_SUBSCRIPTIONS

{{% bannerNote type="code" %}}
data.DATAOBS_SUBSCRIPTION_VARIABLES(subscriptions_project STRING, subscriptions_dataset STRING, filters STRING)
{{%/ bannerNote %}}
...
```sql
CALL carto-st.data.DATAOBS_SUBSCRIPTION_VARIABLES('do-myorg-de4a1b21c14326c53184','do_us_myuser_3a21c14322b214326','');
```

### ENRICH_POINTS

{{% bannerNote type="code" %}}
data.ENRICH_POINTS(input_query, input_id_column, input_geography_column, data_query, data_geography_column, output)
{{%/ bannerNote %}}
...
{{% bannerNote type="code" %}}
data.ENRICH_POINTS_WITH_MEASURES(input_query, input_id_column, input_geography_column, data_query, data_geography_column, output)
{{%/ bannerNote %}}
...
{{% bannerNote type="code" %}}
data.ENRICH_POLYGONS_WITH_AGGREGATION(input_query, input_id_column, input_geography_column, data_query, data_geography_column, variables, output))
{{%/ bannerNote %}}
