...
Check out this [blogpost](https://carto.com/blog/how-we-developed-covid-vaccine-cloud-native-spatial-app/) to learn how we created this dataset and this visualization using the Spatial Extension and a custom application using [CARTO for React](https://docs.carto.com/react).
