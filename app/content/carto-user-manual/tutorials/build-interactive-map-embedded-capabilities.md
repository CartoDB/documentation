...
4. Select “paris_cycling_network” and explore the preview of the map and the details of the table.
   ...
   ![Data Explorer map preview](/img/cloud-native-workspace/tutorials/tutorial11_de_map_preview.png)

   ![Data Explorer data preview](/img/cloud-native-workspace/tutorials/tutorial11_de_data_preview.png)
