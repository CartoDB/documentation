...
To import your data, go to Data Explorer section and click on the *Import data* button on the top right (or the import data icon, if you have a provider or folder selected):
